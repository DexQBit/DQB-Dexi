...
const APP_TITLE = "Dexi Publish | Make your Dexi boards public with one-click";
const APP_DESCRIPTION =
  "Dexi Publish is Dexqbit's customer feedback and publishing tool for boards and roadmaps";
