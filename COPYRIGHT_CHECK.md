...
To verify that all tracked Python files contain the correct copyright header for **Dexqbit** for the year **2025**, run this command from the repository root:
...
- **`-c "Dexqbit"`**: sets the copyright holder.
